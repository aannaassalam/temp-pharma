      ...
      <section>
        <div className="container mx-auto">
          <p className="page-common-desc !text-center">
            Being a part of St John SA means you have access to ongoing
            professional development, extensive training resources, progressive
            terms and conditions of employment and volunteering, and work with
            others who share the St John values and enjoy supporting the
            community.
          </p>
          <p className="page-common-desc !text-center !font-bold text-[#4A4A4A]">
            NOW HIRING: Commercial First Aid Trainer positions available
          </p>
          <p className="page-common-desc !text-center !font-bold text-[#4A4A4A]">
            Click to view the prospectus below
          </p>
          <div className="mb-6 flex justify-center">
            <Image className="w-[220px] h-[248px]" src={circleImage} alt="" />
          </div>
