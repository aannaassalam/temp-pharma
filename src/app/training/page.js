        ...
        <>
            ...
            <section className="relative w-full mb-[80px] h-[300px]">
                <Image
                    ...
                    // height={480}
                />
                <div className="breadCrumb absolute top-4 left-20 mx-auto z-10">
            ...
            <section className="common-sec">
                <div className="container mx-auto">
                    <p className="page-common-desc text-center">
                        ...
                        ridiculus mus.  Cum sociis natoque penatibus et magnis
                        dis parturient montes, nascetur ridiculus mus.  Cum
                        sociis natoque penatibus et magnis dis parturient
                        montes, nascetur ridiculus mus.  
                    </p>
                    <h3 className="common-sec-title text-center">
                        On Site Training
                    </h3>
                    ...
                    <div className="bg-[#038D96] rounded-[12px] p-4 flex flex-col sm:flex-row sm:items-center justify-between mt-6 md:mt-9">
                        <div>
                            ...
                            <p className="text-white text-sm">
                                If you know the course code, you can use our
                                search tool
                            </p>
                        </div>
