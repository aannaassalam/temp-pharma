    ...
    return (
        <>
            <section className="hero-banner mb-[80px]">
                <Image
                    className="w-full h-[67vh] max-md:h-screen absolute z-[-1]"
                    src={banner}
                    alt="banner"
                />
                <div className="container mx-auto">
                    <div className="hero-banner-main items-center py-[100px]">
                        ...
                        <div className="w-full lg:w-1/2 pl-36">
                            <div className="hero-banner-popup">
                                <h3 className="hero-popup-title !font-medium">
                                    Need help finding the right course?
                                </h3>
                                <p className="hero-popup-desc">
                                    Our course wizard can help you find the
                                    right course in four simple steps, or you
                                    can browse through more courses below.
                                </p>
            ...
            <section className="default-card-sec overflow-hidden mb-[80px]">
                <div className="container mx-auto">
                    ...
                    <Swiper
                        ...
                        spaceBetween={30}
                        slidesPerView={3.8}
                        className="default-card-swiper mt-8 !w-[120%] -translate-x-[90px]"
                    >
                        <SwiperSlide>
                            <div className="default-card relative">
                                <span className="default-card-status">
                                    Online
                                </span>
                                <figure>
                                ...
                                <div className="default-card-detail">
                                    <h3 className="default-card-title">
                                        First Aid
                                    </h3>
                                    <p className="default-card-desc">
                                        Lorem ipsum dolor sit amet, consectetur
                                        elit, sed doeiusmod tempor
                                    </p>
                        ...
                        <div className="community-card">
                            ...
                            <div className="community-card-detail">
                                <p className="community-card-desc">
                                    ...
                                    teaches South Australian primary school
                                    children the lifesaving skills of first aid
                                    free of charge. We can arrange for a
                                    qualified St John Trainer to come to your
                                    school and teach students a range of vital
                                    first aid skills, tailored to suit each year
                                    level. 
                                </p>
                                <Link
                                    href="#"
                    ...
                    <div className="mission-card">
                        <div className="mission-card-detail">
                            ...
                            <p className="mission-card-desc">
                                ...
                                adipiscing elit. Aenean commodo ipsum eget
                                dolor. ipsum massa. Cum sociis natoque ipsum et
                                magnis dis parturient montes, ipsum ridiculus
                                mus.  
                            </p>
                        </div>
                        <figure>
